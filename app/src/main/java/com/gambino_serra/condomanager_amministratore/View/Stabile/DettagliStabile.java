...
public class DettagliStabile extends Fragment {
    ...
    public DettagliStabile() {}

    /**
     * Use this factory method to create a new instance of this Menu using the provided parameters.
     */
    public static DettagliStabile newInstance(String param1, String param2) {
        DettagliStabile fragment = new DettagliStabile();
