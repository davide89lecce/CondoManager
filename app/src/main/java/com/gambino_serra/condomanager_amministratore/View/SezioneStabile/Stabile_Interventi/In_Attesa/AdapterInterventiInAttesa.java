...
public class AdapterInterventiInAttesa extends RecyclerView.Adapter<AdapterInterventiInAttesa.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(com.gambino_serra.condomanager_amministratore.View.SezioneStabile.Stabile_Interventi.In_Attesa.InterventiInAttesa.myOnClickListener);
