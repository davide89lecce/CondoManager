...
public class AdapterInterventCompletati extends RecyclerView.Adapter<AdapterInterventCompletati.MyViewHolder> {
    ...
    public AdapterInterventCompletati(ArrayList<CardTicketIntervento> dataset) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(com.gambino_serra.condomanager_amministratore.View.SezioneStabile.Stabile_Interventi.Completati.InterventiCompletati.myOnClickListener);
