...
public class InterventiInCorso extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.sezionestabile_tab_incorso, container, false);
    }
    ...
    public void onStart() {
        ...
        recyclerView = (RecyclerView) getActivity().findViewById(R.id.my_recycler_inCorso);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (  ( cardTicketIntervento_inCorso.getStato()).equals("in corso")  )
                {
                    interventi_inCorso.add(cardTicketIntervento_inCorso);
                }

                adapter = new AdapterInterventiInCorso(interventi_inCorso);
