...
import com.gambino_serra.condomanager_amministratore.Model.Entity.MarkerFornitore;
import com.gambino_serra.condomanager_amministratore.Model.FirebaseDB.FirebaseDB;
import com.gambino_serra.condomanager_amministratore.View.DrawerMenu.MainDrawer;
import com.gambino_serra.condomanager_amministratore.View.Home.BachecaFornitori.AggiuntaFornitore.AggiungiFornitore;
 ...
 */
@RuntimePermissions
public class MappaFornitori extends FragmentActivity implements
    ...
    ArrayList<MarkerFornitore> fornitori;
    private ArrayList<MarkerFornitore> data;
    String categoria;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mappa_fornitori);

        firebaseAuth = FirebaseAuth.getInstance();
        data = new ArrayList<MarkerFornitore>();
        fornitoreMap = new HashMap<String,Object>();
        fornitori = new ArrayList<MarkerFornitore>();
    ...
    protected void loadMap(GoogleMap googleMap) {
        map = googleMap;
        if (map != null) {
            MappaFornitoriPermissionsDispatcher.getMyLocationWithCheck(this);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent setting = new Intent(MappaFornitori.this, MainDrawer.class);
        ...
        Query query;
        query = FirebaseDB.getFornitori().orderByChild("categoria").equalTo(categoria);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                fornitoreMap = new HashMap<String, Object>();
                fornitoreMap.put("id", dataSnapshot.getKey()); //primo campo del MAP
                ...
                visualizzaMarkers(fornitoreMap);
            }
            @Override
    ...
    public void visualizzaMarkers(final Map<String, Object> stabileMap){
                ...
                try {
                    ...
                    MarkerFornitore markerFornitore = new MarkerFornitore(
                            fornitoreMap.get("id").toString(),
                            fornitoreMap.get("nome_azienda").toString(),
                            fornitoreMap.get("indirizzo").toString(),
                            fornitoreMap.get("latitudine").toString(),
                            fornitoreMap.get("longitudine").toString()
                    );

                        // inserisce l'oggetto stabile nell'array stabili
                        fornitori.add(markerFornitore);

                        //codice latitudine longitudine
                        LatLng ltlnHelpers;
                        ltlnHelpers = new LatLng(Double.parseDouble(markerFornitore.getLatitudine()), Double.parseDouble(markerFornitore.getLongitudine()));

                        //Aggiunge il marker con il colore in base alla priorità

                            map.addMarker(new MarkerOptions()
                                    .position(ltlnHelpers)
                                    .title(markerFornitore.getNomeFornitore())
                                    .snippet(markerFornitore.getIndirizzo())
                        ...
                        map.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                            ...
                            public void onInfoWindowClick(Marker arg0) {
                                for (final MarkerFornitore fornitore : fornitori) {
                                    if ((fornitore.getNomeFornitore()).equals(arg0.getTitle())) {
                                        Intent intent = new Intent(getApplicationContext(), AggiungiFornitore.class);
                                        bundle.putString("uidFornitore", fornitore.getIdFornitore());
