package com.gambino_serra.condomanager_amministratore.View.SezioneStabile.Stabile_Interventi.In_Attesa;
...
public class InterventiInAttesa extends Fragment {
    ...
    ArrayList<CardTicketIntervento> interventi_inAttesa;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.sezionestabile_tab_inattesa, container, false);
    }
    ...
    public void onStart() {
        ...
        interventi_inAttesa = new ArrayList<CardTicketIntervento>();

        myOnClickListener = new MyOnClickListener(context);

        recyclerView = (RecyclerView) getActivity().findViewById(R.id.my_recycler_inAttesa);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                CardTicketIntervento cardTicketIntervento_inAttesa = new CardTicketIntervento(
                ...
                if (       ( cardTicketIntervento_inAttesa.getStato().equals("in attesa")  )
                       ||  ( cardTicketIntervento_inAttesa.getStato().equals("rifiutato")  ) )
                {
                    interventi_inAttesa.add(cardTicketIntervento_inAttesa);
                }

                adapter = new AdapterInterventiInAttesa(interventi_inAttesa);
    ...
    private static class MyOnClickListener extends AppCompatActivity implements View.OnClickListener {
        ...
        private void detailsSegnalazione(View v) {
            ...
            Intent intent = new Intent(context, com.gambino_serra.condomanager_amministratore.View.SezioneStabile.Stabile_Interventi.Intervento.Intervento.class);
